    ...
    private final class RequestHandler extends Thread
    {
        ...
        private void connectRelay(String remoteAddress)
        {
            try {
                ...
                /*
                for (Map.Entry<String, List<String>> entries : proxyToServer.getHeaderFields().entrySet()) {
                    String values = "";
              ...
              //  String contentType = proxyToServer.getHeaderField("Content-Type");
               ...
               // cked by CORS policy: No 'Access-Control-Allow-Origin' header is present on the requested resource.
