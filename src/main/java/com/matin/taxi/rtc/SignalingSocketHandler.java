...
/**
 * Created by IntelliJ IDEA. Project : springboot-webrtc User: hendisantika
 * Email: hendisantika@gmail.com Telegram : @hendisantika34 Date: 28/12/20 Time:
 * 17.42
 */
...
public class SignalingSocketHandler extends TextWebSocketHandler {
	...
	public void afterConnectionEstablished(WebSocketSession session) throws Exception {
		...
		// kmi newMenOnBoard.setType(TYPE_INIT);
		// kmi newMenOnBoard.setSender(session.getId());
	...
	protected void handleTextMessage(WebSocketSession session, TextMessage message) throws Exception {
		...
		// kmi WebSocketSession destSocket = connectedUsers.get(destinationUser);
	...
	private void removeUserAndSendLogout(final String sessionId) {
		...
		// kmi menOut.setType(TYPE_LOGOUT);
		// kmi menOut.setSender(sessionId);
