...
var b='<tbody>';
			var 	r1='<tr><td><a href="/owners/1">George Franklin</a></td><td style="padding-left: 5px;padding-bottom:3px; font-size: 12px;">Тодор Хаджистанчев, Дълбокото дере, кв. Виница,  Приморски <br/> istikbal, 189, бул. Сливница, ж.к. Победа, Варна, Младост</td><td>Madison</td></tr>';
			var 	r2='<tr><td><a href="/owners/9">David Schroeder</a></td><td style="padding-left: 5px;padding-bottom:3px; font-size: 12px;">2749 Blackhawk Trail</td><td>Madison</td></tr>';
			 
			var tableEND='</tbody></table>';
			
			
			var table= tableSTART+b+r1+r2+tableEND;
			...
			node_1.setAttribute('name', 'TaxiControl');
